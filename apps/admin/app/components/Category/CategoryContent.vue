<template>
  <div class="app-container">
    ...
    >
      ...
      <div class="form-item">
        <EditorTinymce ref="editorRef" v-model="formData.content" :height="600" />
      </div>
      <el-form-item class="form-title">
        其它设置
      </el-form-item>
...
const categoryOptions = computed(() => getCategoryByType(listStore.category as any, (route.query.type as string) || ''))
...
async function handleCancel() {
  await tagsViewStore.delView({ path: route.path, fullPath: route.fullPath, name: route.name as string })
