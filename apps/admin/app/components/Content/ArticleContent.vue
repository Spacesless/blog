<template>
  <div class="app-container">
    ...
    >
      ...
      <ContentBangumiParam v-if="currentType === 'bangumi'" :params="formData" />
...
import { getCategoryByType, parseTime } from '~/utils'
...
async function handleCancel() {
  ...
  router.push({ path: `/content/${currentType.value === 'bangumi' ? 'bangumi' : 'article'}` })
}
